...
namespace Pulumi.Squid
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Squid.version.txt");
    ...
    internal sealed class SquidResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public SquidResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
